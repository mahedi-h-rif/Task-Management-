...
import api from '../../service/Api';  // Adjust the import path based on your project structure
...
const RegisterForm = () => {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      // You may want to automatically log in the user after registration
      // or redirect them to the login page
      // For example, you can use navigate('/login') to redirect to the login page
      // or implement the login logic here if needed
    } catch (error) {
  ...
  return (
    <div className="bg-gray-400 dark:bg-gray-800 h-screen overflow-hidden flex items-center justify-center">
      <div className="bg-white lg:w-6/12 md:7/12 w-8/12 shadow-3xl rounded-xl">
        ...
        <form className="p-12 md:p-24" onSubmit={handleRegister}>
